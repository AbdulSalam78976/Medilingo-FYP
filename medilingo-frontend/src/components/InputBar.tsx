  ...
  return (
    <div className="border-t border-line bg-bg px-4 py-4 flex-shrink-0 z-20">
      ...
      <div className="max-w-[760px] mx-auto">
        ...
        {/* Composer card */}
        <div className={`card shadow-card flex items-center gap-2 px-4 py-2.5 transition-shadow ${
          isListening ? 'border-teal ring-2 ring-teal/20' : 'hover:border-line-strong'
        }`}>
          {/* Sparkle icon */}
          <svg className="flex-shrink-0 self-start mt-2.5" width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="#1A5F7A" strokeWidth="1.6" strokeLinecap="round" strokeLinejoin="round">
          ...
          <textarea
            ...
            rows={1}
            disabled={isLoading}
            className="flex-1 resize-none bg-transparent text-[14px] text-ink placeholder:text-ink-5 focus:outline-none disabled:opacity-50 py-2 leading-relaxed"
            style={{ minHeight: '36px', maxHeight: '160px' }}
          />

          {/* Controls row */}
          <div className="flex items-center gap-1.5 flex-shrink-0 self-end mb-1">
            {/* Language selector */}
