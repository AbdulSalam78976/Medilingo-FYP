...
export function RegisterPage() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    try {
      ...
      toast.success('Account created! Welcome to MediLingo.');
      ...
      <div className="w-full max-w-[400px] animate-fade-in">
        ...
        <div className="bg-paper border border-line rounded-lg shadow-card p-8">
          ...
          <p className="text-[13px] text-ink-4 text-center mb-7">
            Start asking health questions in your language
          </p>

          <form onSubmit={handleSubmit} className="flex flex-col gap-4" noValidate>
            {/* Email */}
            <div>
              <label htmlFor="reg-email" className="block text-[13px] font-medium text-ink-2 mb-1.5">
                Email
              </label>
              <input
                id="reg-email"
            ...
            {/* Password */}
            <div>
              <label htmlFor="reg-password" className="block text-[13px] font-medium text-ink-2 mb-1.5">
                Password
              </label>
              <input
                id="reg-password"
          ...
          <p className="mt-6 text-center text-[13px] text-ink-4">
            ...
            <Link to="/login" className="text-blue font-medium hover:text-blue-700 transition-colors">
              Sign in
            </Link>
          </p>
        </div>
